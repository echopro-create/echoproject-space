...
export default function Home() {
  return (
    <section className="container mx-auto px-4 py-16 md:py-24 text-center">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight mb-4"> РѕСЃР»Р°РЅРёСЏ РїРѕСЃР»Рµ Р¶РёР·РЅРё, РєРѕРіРґР° СЃР»РѕРІР° РїРѕ-РЅР°СЃС‚РѕСЏС‰РµРјСѓ РЅСѓР¶РЅС‹
      </h1>
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4">
        ...
        <a href="/about" className="px-8 py-3 border border-gray-300 text-gray-900 rounded-full font-bold hover:bg-gray-100 transition-colors"> Р°Рє СЌС‚Рѕ СЂР°Р±РѕС‚Р°РµС‚
        </a>
      </div>
    </section>
  );
