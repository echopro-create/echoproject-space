...
const schema = z.object({
  recipient_email: z.string().email('?????????????????????????????????? email'),
  ...
  return (
    <div className="bg-white text-gray-900 font-sans min-h-screen flex flex-col">
      <section className="container mx-auto px-4 py-16 md:py-24 text-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight mb-4">???????????????????? ????????????????????????????????</h1>
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-12">?????????????????????????????????? ???????????????????????? ?????????????????????????????????????, ????????????????????????????? ????????????????????? ????????????????????????????????????????? ???? ?????????????????????????? ?????????????????????????.</p>
      </section>
      ...
      <section className="container mx-auto px-4 pb-16 max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          ...
          <div>
            <label htmlFor="recipient_email" className="block text-sm font-medium text-gray-700">Email ??????????????????????????????????????????</label>
          ...
          <div>
            <label htmlFor="content_text" className="block text-sm font-medium text-gray-700">????????????????????? ????????????????????????????????</label>
          ...
          <div>
            <label htmlFor="mode" className="block text-sm font-medium text-gray-700">???????????????????? ?????????????????????????????????</label>
          ...
          {formData.mode === 'scheduled' && (
            <div>
              <label htmlFor="delivery_at" className="block text-sm font-medium text-gray-700">?????????????????? ???? ???????????????????? ?????????????????????????????????</label>
              <input id="delivery_at" name="delivery_at" type="datetime-local" required value={formData.delivery_at}
                onChange={handleChange}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 sm:text-sm" />
              <p className="mt-1 text-xs text-gray-500">?????????????????????? ????????????????????????????????????? ???? UTC, ????????????????????????: Europe/Oslo</p>
            </div>
          )}
